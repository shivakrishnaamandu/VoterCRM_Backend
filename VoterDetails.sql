...
CREATE TABLE VoterDetails(
      ...
      voter_address text ,/*address is keyword modified to voter_address*/
      street text,
      ward text ,
      ...
      local_corporator_political_party	varchar(100),
      FOREIGN KEY (local_corporator_political_party) REFERENCES PoliticalParties(Party_Name),
