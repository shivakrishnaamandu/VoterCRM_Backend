...
class VoterDetails_new(db.Model):
    __tablename__ = "VoterDetails_new"
    ...
    def __init__(self, voter_id, voter_name, voter_father_name, address, street, ward, phone_number, whatsapp_number,
                 voter_gender, voter_marital_status, voter_age, voter_educational_qualification, voter_profession,
                 voter_income_per_month, voter_income_per_year, voter_family_income_per_month,
                 number_of_votes_in_voters_family, number_of_votes_in_voters_extended_family, voter_caste,
                 voter_political_party, whether_voter_is_politically_neutral,
                 whether_voter_is_getting_government_benefits, whether_voters_family_is_getting_government_benefits,
                 voter_work_location, whether_voter_accepts_money_from_political_party,
                 whether_voters_family_accepts_money_from_political_party, number_of_police_cases_on_voter,
                 number_of_police_cases_on_voters_family_members, voter_has_own_house,
                 whether_voter_is_migrated_from_another_place, voter_opinion_on_present_government,
                 opinion_label_on_present_government, voter_opinion_on_local_MLA, opinion_label_on_local_MLA,
                 local_MLA_political_party, voter_opinion_on_opposition_party_MLA_candidate,
                 opinion_label_on_opposition_party_MLA_candidate, opposition_party_MLA_candidate_political_party,
                 voter_opinion_on_local_coporator_or_village_president,
                 opinion_label_on_local_coporator_or_village_president, local_coporator_political_party,
                 which_political_party_you_wish_to_vote, BPL, reservation_category, voting_first_time,
                 constituency_name, polling_booth_name, pincode, latitude, longitude, is_voter_handicap,
                 number_of_members_visited_foreign_country_in_voters_family, number_of_dependents_of_the_voter,
                 voter_religion, voter_has_own_car, voter_has_own_bike, voter_mother_tongue,
                 voter_monthly_spending, voter_family_monthly_spending, voted_in_last_election):
